...
export class PdmService extends BaseService {
 
  private url = `${environment.api.path}/pdm`;
  pdm: any[]
  pdmFilter: any[]
  ...
  getPdmFilterList(): any[] {
    return this.pdmFilter;
  }

  setPdmList(nuevoValor: any[]) {    
    this.pdm = nuevoValor;
  }

  setPdmFilterList(nuevoValor: any[]) {    
    this.pdmFilter = nuevoValor;
  }
